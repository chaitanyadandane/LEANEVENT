		<div>
			...
			<button style="margin-left: 85%; margin-top: 4%;background-color: green; width: 7%; height: 32px; border:none;border-radius: 14px;"><a href="<?php echo site_url('addevent');?>" target="_self" style="color: white;">Agregar</a></button>
