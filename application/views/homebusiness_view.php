			...
			<div class="displayheader" style="margin-top: 8%;">
				<table style="width: 100%; border-collapse: collapse;">
					...
					<tr style="border-bottom: solid 2pt #F5F5F5; font-size: 9pt;">
						...
						<td class="textcenter"><a href="<?php echo site_url('Businesseventconfirm');?>?event_id=<?php echo $event->E_ID; ?>"><button name= 'confirmbtn' type="submit" value="Confirmar" style="border-radius: 14px; width: 65%; height: 32px; background-color: #FFC300; border: none; color: white;" onclick="setColor('confirmbtn','green')">Confirmar</button></a></td>
					</tr>
				<?php } ?>
				</table>
			</div>
