		...
		<div class="imagelink">
			...
			<a href="<?php echo site_url('profileagent');?>">PERFIL</a>
		</div>
		<div style=" margin: 0% 15% 5% 15%;">
			<h2>Tu Informaci&oacuten del perfil</h2>
			<?php echo form_open('profileagent'); ?>
			<?php foreach($profiles as $profile) { ?>
			<div style="display: flex;">
				<div style="width: 33.33%">
					<!-- <p><input type="hidden" name=""><?php echo $loginid; ?></p>	 -->
					<p><i class="fa fa-book" style="color: black; padding-right: 5%"></i><?php echo $profile->FNAME; ?></p> 
					<p><i class="fa fa-book" style="color: black; padding-right: 5%"></i><?php echo $profile->LNAME; ?></p>
					<p><i class="fa fa-user" style="color: black; padding-right: 5%"></i><?php echo $profile->USERNAME; ?></p>
				</div>
				<div style="width: 33.33%">
					<p><i class="fa fa-map-marker" style="color: black; padding-right: 5%"></i><?php echo $profile->ADDRESS,", ",$profile->CITY,", ",$profile->STATE,", ",$profile->ZIP; ?></p>
					<p><i class="fa fa-phone" style="color: black; padding-right: 5%"></i><?php echo "+ ",$profile->PHONE; ?></p>
					<p><i class="fa fa-paper-plane-o" style="color: black; padding-right: 5%"></i><?php echo $profile->EMAIL; ?></p>
				</div>
				<div style="width: 33.33%">
			...
			<h2>Estar en contacto</h2><hr>
					...
					<tr>
						...
						<td rowspan="4" style="text-align: center;">
							...
							<p>
								<?php echo form_input(array('type'=>"button", 'name'=>"", 'value'=>"Seleccionar Logo", 'style'=>"background-color: #FFC300; color: white; border-radius: 14px; width: 60%;height: 35px;border: none;"));?>
							</p>
						</td>	
					</tr> 
					<tr>
					...
					<tr>
						<th><?php echo form_label('Numero de Registro del Inscrito');?></th>
					</tr>  	
						<td>
							<?php echo form_input(array('name'=>"number",'placeholder'=>"Numero de Registro del Inscrito",'style'=>"width:188%; height: 30px; padding: 2%;border: none;"));?>
						</td>
					</tr>
					<tr>
						  	<td>
...
var fname = document.forms['profileagent_form']['fname'];
var number = document.forms['profileagent_form']['number'];
var email = document.forms['profileagent_form']['email'];
var phone = document.forms['profileagent_form']['phone'];
var username = document.forms['profileagent_form']['username'];
var password = document.forms['profileagent_form']['password'];


var fname_err_msg = document.getElementById('fname_err_msg');
var number_err_msg = document.getElementById('number_err_msg');
...
function Validate() {
  ...
  if (number.value == "") {
    ...
    // document.getElementById('registrationnumber_in').style.color = "red";
    document.getElementById("number_err_msg").innerHTML = "registrationnumber is required";
    number.focus();
    return false;
  }
  // validate email
...
function numberVerify() {
  if (nnumber.value != "") {
    var number_chk = /^[0-9 ]+$/;
    if(!number_chk.test(number.value)){
    document.getElementById("number_err_msg").innerHTML = "Enter registration number";
    return false;
  } else {
    number.style.border = "1px solid #5e6e66";
    number_err_msg.innerHTML = "";
    return true;
  }
}
}
...
function phoneVerify() {
  ...
  if(!phone_chk.test(number.value)){
